...
// --- 3. ТОГЛООМЫН ХУУДАСНЫ МӨРҮҮД (Кино шиг ангилал) ---
window.GAME_SECTIONS =[
  { id: 'grow_puzzle',   title: '🧩 Оюун ухаан & Таавар',       key: 'puzzle' },
  { id: 'grow_strategy', title: '♟️ Стратеги & Хөлөгт тоглоом', key: 'strategy' },
  { id: 'grow_arcade',   title: '🕹️ Сонгодог Аркад',           key: 'arcade' },
  { id: 'grow_multi',    title: '👥 Олон тоглогчтой (Online)',  key: 'multi' }
];
